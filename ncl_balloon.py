...
Generated from: ncl_balloon.xml
...
BALLON_STATE_BURST = 1 # Nichrome wire is currently on cutting the balloon
enums['BALLOON_STATE'][1] = EnumEntry('BALLON_STATE_BURST', '''Nichrome wire is currently on cutting the balloon''')
...
# BALLOON_COMP_PARACHUTES
enums['BALLOON_COMP_PARACHUTES'] = {}
BALLOON_COMP_PARACHUTES_1 = 1 # First parachute on the balloon
enums['BALLOON_COMP_PARACHUTES'][1] = EnumEntry('BALLOON_COMP_PARACHUTES_1', '''First parachute on the balloon''')
BALLOON_COMP_PARACHUTES_2 = 2 # Second parachute on the balloon
enums['BALLOON_COMP_PARACHUTES'][2] = EnumEntry('BALLOON_COMP_PARACHUTES_2', '''Second parachute on the balloon''')
BALLOON_COMP_PARACHUTES_3 = 4 # Third parachute on the balloon
enums['BALLOON_COMP_PARACHUTES'][4] = EnumEntry('BALLOON_COMP_PARACHUTES_3', '''Third parachute on the balloon''')
BALLOON_COMP_PARACHUTES_ENUM_END = 5 # 
enums['BALLOON_COMP_PARACHUTES'][5] = EnumEntry('BALLOON_COMP_PARACHUTES_ENUM_END', '''''')
...
MAVLINK_MSG_ID_TEMP_PRES_SENSOR = 180
MAVLINK_MSG_ID_COMPONENT_STATE = 181
...
class MAVLink_gps_raw_int_message(MAVLink_message):
        ...
        System (GPS). This is                                 NOT the
        global position estimate of the system, but rather a RAW
        sensor value. See message GLOBAL_POSITION for the global
...
class MAVLink_temp_pres_sensor_message(MAVLink_message):
        '''
        The pressure and temperature information from the onboard
        sensors.
        '''
        id = MAVLINK_MSG_ID_TEMP_PRES_SENSOR
        name = 'TEMP_PRES_SENSOR'
        fieldnames = ['mission_time', 'temperature', 'baro_altitude', 'pressure']
        ordered_fieldnames = [ 'mission_time', 'temperature', 'baro_altitude', 'pressure' ]
        format = '<Ifff'
        ...
        def __init__(self, mission_time, temperature, baro_altitude, pressure):
                MAVLink_message.__init__(self, MAVLink_temp_pres_sensor_message.id, MAVLink_temp_pres_sensor_message.name)
                self._fieldnames = MAVLink_temp_pres_sensor_message.fieldnames
        ...
        def pack(self, mav, force_mavlink1=False):
                return MAVLink_message.pack(self, mav, 51, struct.pack('<Ifff', self.mission_time, self.temperature, self.baro_altitude, self.pressure), force_mavlink1=force_mavlink1)
...
class MAVLink_component_state_message(MAVLink_message):
        ...
        fieldnames = ['time_usec', 'heaters', 'parachutes', 'nichrome_wire']
        ordered_fieldnames = [ 'time_usec', 'heaters', 'parachutes', 'nichrome_wire' ]
        format = '<QBBB'
        ...
        def __init__(self, time_usec, heaters, parachutes, nichrome_wire):
        ...
        def pack(self, mav, force_mavlink1=False):
                return MAVLink_message.pack(self, mav, 12, struct.pack('<QBBB', self.time_usec, self.heaters, self.parachutes, self.nichrome_wire), force_mavlink1=force_mavlink1)
...
mavlink_map = {
        ...
        MAVLINK_MSG_ID_TEMP_PRES_SENSOR : MAVLink_temp_pres_sensor_message,
...
class MAVLink(object):
        ...
        def gps_raw_int_encode(self, time_usec, fix_type, lat, lon, alt, eph, epv, vel, cog, satellites_visible):
                ...
                (GPS). This is                                 NOT the
                global position estimate of the system, but rather a
                RAW sensor value. See message GLOBAL_POSITION for the
        ...
        def temp_pres_sensor_encode(self, mission_time, temperature, baro_altitude, pressure):
                '''
                The pressure and temperature information from the onboard sensors.
                ...
                '''
                return MAVLink_temp_pres_sensor_message(mission_time, temperature, baro_altitude, pressure)

        def temp_pres_sensor_send(self, mission_time, temperature, baro_altitude, pressure, force_mavlink1=False):
                '''
                The pressure and temperature information from the onboard sensors.
                ...
                '''
                return self.send(self.temp_pres_sensor_encode(mission_time, temperature, baro_altitude, pressure), force_mavlink1=force_mavlink1)

        def component_state_encode(self, time_usec, heaters, parachutes, nichrome_wire):
                '''
                The state of the different components onboard the balloon
                ...
                parachutes                : Flags for up to 8 onboard parachutes (1 for deployed, 0 for not deployed) (uint8_t)
                nichrome_wire             : Flag for the nichrome wire being on (1 is on, 0 is off) (uint8_t)

                '''
                return MAVLink_component_state_message(time_usec, heaters, parachutes, nichrome_wire)

        def component_state_send(self, time_usec, heaters, parachutes, nichrome_wire, force_mavlink1=False):
                '''
                The state of the different components onboard the balloon
                ...
                '''
                return self.send(self.component_state_encode(time_usec, heaters, parachutes, nichrome_wire), force_mavlink1=force_mavlink1)
